  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center p-4 md:p-6 pointer-events-none">
      <motion.nav
        ...
        className={`pointer-events-auto relative z-50 flex items-center justify-between gap-6 px-4 py-2 md:px-6 md:py-3 rounded-full transition-all duration-500 ${
          scrolled
